...
int ms_x_orientation_init(struct smdk4x12_sensors_handlers *handlers,
	struct smdk4x12_sensors_device *device)
{
	struct ms_x_orientation_data *data = NULL;
	...
	data = (struct ms_x_orientation_data *) calloc(1, sizeof(struct ms_x_orientation_data));
...
int ms_x_orientation_deinit(struct smdk4x12_sensors_handlers *handlers)
{
...
int ms_x_orientation_activate(struct smdk4x12_sensors_handlers *handlers)
{
	struct ms_x_orientation_data *data;
	int rc;
	...
	data = (struct ms_x_orientation_data *) handlers->data;
...
int ms_x_orientation_deactivate(struct smdk4x12_sensors_handlers *handlers)
{
	struct ms_x_orientation_data *data;
	int rc;
...
int ms_x_orientation_set_delay(struct smdk4x12_sensors_handlers *handlers, int64_t delay)
{
	struct ms_x_orientation_data *data;
	int rc;
	...
	struct sensors_event_t *event)
{
	...
	int input_fd;
	int rc;
	int sensorId = SENSOR_TYPE_ORIENTATION;
...
struct smdk4x12_sensors_handlers ms_x_orientation = {
	...
	.deactivate = ms_x_orientation_deactivate,
	.set_delay = ms_x_orientation_set_delay,
	.get_data = ms_x_orientation_get_data,
	.activated = 0,
	.needed = 0,
	.poll_fd = -1,
	.data = NULL,
